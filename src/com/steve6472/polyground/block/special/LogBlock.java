...
//				int s = Util.getRandomInt(4, 1);
				...
				BreakParticle p = new BreakParticle(
					new Vector3f(
						...
						RandomUtil.randomFloat(-0.01f, 0.01f)),
					new Vector3f(
						x + RandomUtil.randomFloat(-0.5f, 0.5f) + 0.5f,
						y + RandomUtil.randomFloat(-0.5f, 0.5f) + 0.5f,
						z + RandomUtil.randomFloat(-0.5f, 0.5f) + 0.5f),
					RandomUtil.randomFloat(0.02f, 0.07f),
					new Vector4f(
						minU,
						maxU,
						minV,
