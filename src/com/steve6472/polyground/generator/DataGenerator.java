package com.steve6472.polyground.generator;

import com.steve6472.polyground.generator.models.*;
import com.steve6472.polyground.generator.models.slab.*;
import com.steve6472.polyground.generator.models.stair.StairBlock;
import com.steve6472.polyground.generator.special.*;
...
//	}
	...
	public void generate() throws IOException
	{
		...
		/* Smooth Slab */
		sidedSlabFamily(
			"smooth_slab_top", "smooth_slab_bottom", "double_smooth_slab", "smooth_slab",
			"smooth_stone", "smooth_stone", "smooth_stone_slab");

		/* Old Grass Block Slab */
		sidedSlabFamily(
			"old_grass_block_slab_top", "old_grass_block_slab_bottom", "old_grass_block", "old_grass_block_slab",
			"old_grass_block_top", "dirt", "old_grass_block_slab_side", "old_grass_block_side");

		/* Dirt Slab */
		fullSlabFamily("dirt_slab_top", "dirt_slab_bottom", "dirt", "dirt_slab", "dirt");

		/* Old Full Grass Block Slab */
		fullSlabFamily("old_full_grass_block_slab_top", "old_full_grass_block_slab_bottom", "old_full_grass_block",
			"old_full_grass_block_slab", "old_grass_block_top");
		...
		item("grass_block_slab",
			new ItemFromBlock("grass_block_slab_bottom"),
			new SlabSpecial("grass_block_slab_top", "grass_block_slab_bottom", "grass"), "grass_block_slab_bottom");
	...
	{
		block(name, new TintedGrassBlock(red, green, blue, "dirt_cut", "dirt", "grass_block_side_overlay", "grass_block_top"),
			new SimpleSpecial("tinted"));
		item(name, new ItemFromBlock(name), null, name);
	}

	private void bottomSlabGrassTinted(String name, float red, float green, float blue) throws IOException
	{
		block(name, new SlabBottomTintedGrass(red, green, blue, "dirt_cut", "dirt", "grass_block_side_overlay", "grass_block_top"),
			new TintedSlabBlockSpecial("bottom"));
	}

	private void topSlabGrassTinted(String name, float red, float green, float blue) throws IOException
	{
		block(name, new SlabTopTintedGrass(red, green, blue, "dirt_cut", "dirt", "grass_block_side_overlay", "grass_block_top"),
			new TintedSlabBlockSpecial("top"));
	}
	...
	private void fullSlabFamily(String topName, String bottomName, String bothName, String itemName, String texture)
		throws IOException
	{
		topSlabFull(topName, texture);
		bottomSlabFull(bottomName, texture);
		doubleSlabFull(bothName, texture,
			topName, bottomName);
		item(itemName,
			new ItemFromBlock(bottomName),
			new SlabSpecial(topName, bottomName, bothName), bottomName);
	}
	...
	private void sidedSlabFamily(String topName, String bottomName, String bothName, String itemName, String topTexture, String bottomTexture, String sideTexture)
		throws IOException
	{
		topSlabSided(topName, topTexture, bottomTexture, sideTexture);
		bottomSlabSided(bottomName, topTexture, bottomTexture, sideTexture);
		doubleSlabSided(bothName, topTexture, bottomTexture, sideTexture,
			topName, bottomName);
		item(itemName,
			new ItemFromBlock(bottomName),
			new SlabSpecial(topName, bottomName, bothName), bottomName);
	...
	private void sidedSlabFamily(
		String topName, String bottomName, String bothName, String itemName, String topTexture, String bottomTexture, String slabSideTexture, String blockSideTexture)
		throws IOException
	{
		...
		doubleSlabSided(bothName, topTexture, bottomTexture, blockSideTexture,
			topName, bottomName);
		item(itemName,
			new ItemFromBlock(bottomName),
			new SlabSpecial(topName, bottomName, bothName), bottomName);
