...
public class AABBUtil
{
	...
	{
		if (!(box.maxY > block.minY && box.minY < block.maxY)) return xa;
		if (!(box.maxZ > block.minZ && box.minZ < block.maxZ)) return xa;
	...
	{
		if (!(box.maxX > block.minX && box.minX < block.maxX)) return ya;
		if (!(box.maxZ > block.minZ && box.minZ < block.maxZ)) return ya;
	...
	{
		if (!(box.maxX > block.minX && box.minX < block.maxX)) return za;
		if (!(box.maxY > block.minY && box.minY < block.maxY)) return za;
