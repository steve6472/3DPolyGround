...
class Vec6
{
	...
	public boolean compare(Vec6 o, boolean x, boolean y, boolean z, EnumFace face)
	{
		...
		if (x)
			...
			f = f && (x0 == o.x0 - face.getXOffset() || x1 == o.x1 - face.getXOffset());
		if (y)
			f = f && (y0 == o.y0 && y1 == o.y1);
		else
			f = f && (y0 == o.y0 - face.getXOffset() || y1 == o.y1 - face.getXOffset());
		if (z)
			f = f && (z0 == o.z0 && z1 == o.z1);
		else
			f = f && (z0 == o.z0 - face.getXOffset() || z1 == o.z1 - face.getXOffset());
		return f;
	}
