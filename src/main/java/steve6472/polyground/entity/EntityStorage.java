...
import steve6472.polyground.entity.model.IPostRender;
import steve6472.polyground.entity.model.models.EmptyModel;
import steve6472.polyground.entity.model.models.ModelAI;
import steve6472.polyground.entity.model.models.ModelBlock;
...
public class EntityStorage
{
	...
	public void addEntity(EntityBase entity)
	{
		if (entity instanceof FallingBlock)
			entities.get(modelBlock).add(entity);
		if (entity instanceof AIEntity)
			entities.get(modelAI).add(entity);
	}
