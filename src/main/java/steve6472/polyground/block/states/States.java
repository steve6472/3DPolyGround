...
public class States
{
	...
	public static final EnumProperty<EnumFlowerColor> FLOWER_COLOR = EnumProperty.create("color", EnumFlowerColor.class, EnumFlowerColor.RED, EnumFlowerColor.GREEN, EnumFlowerColor.BLUE);
