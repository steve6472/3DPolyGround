 ...
 *
 ***********************/
public class ConnectorUp extends AbstractGate
{
	...
	public ConnectorUp()
	{
		super("connector_to_up");
	}

	@Override
	protected Vector3i[] inputPositions()
	{
		return new Vector3i[] {new Vector3i(2, 0, 0)};
	}

	@Override
	protected Vector3i[] outputPositions()
	{
		return new Vector3i[] {new Vector3i(1, 1, 0), new Vector3i(0, 0, 0)};
	}
