...
import steve6472.polyground.commands.arguments.ModelLayerArgument;
...
public class ModelLayerCommand extends Command
{
	...
	{
		dispatcher.register(literal("modellayer").then(argument("modelLayer", ModelLayerArgument.modelLayer()).executes(c ->
		{
